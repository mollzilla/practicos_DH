...
¿Qué sucede ahora en imprimir.php si enviamos el formulario con datos?
...
<h1>Practica Persistencia y validacion</h1>
...
<form class="" action="home.php" method="post">
  <div class="form-group">
    ...
    <input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" value=<?=isset($_POST["email"])? $_POST["email"] : ""?>>
  ...
  <div class="form-group form-check">
    ...
    <label class="form-check-label" for="exampleCheck1">Check porque si</label>
  </div>
