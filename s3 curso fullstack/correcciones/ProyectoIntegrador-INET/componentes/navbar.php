    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="" action="/ProyectoIntegrador-INET/operaciones/registrar.php" method="post">
            ...
            <div class="input-group mb-3">
              ...
              <input type="password" name="password" class="form-control" aria-label="password" placeholder="Ingrese contraseña" id="passwordRegister" required maxlength="20" minlength="6">
      ...
      <div class="modal-content">
        ...
        <form action="operaciones/loguear.php" method="post">
          ...
          <div class="input-group mb-3">
            ...
            <input type="password" name="password" class="form-control" aria-label="password" placeholder="Ingrese contraseña" id="password" required maxlength="20" minlength="6">
